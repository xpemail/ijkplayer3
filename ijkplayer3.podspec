...
Pod::Spec.new do |s|
  ...
  s.name         = "ijkplayer3"
  s.version      = "0.6.2.2"
  s.summary      = "ijkplayer0.6.2.1 base on ffmpeg 3.1"
 

  s.homepage     = "https://github.com/xpemail/ijkplayer3"
  ...
  s.source       = { :git => "https://github.com/xpemail/ijkplayer3.git", :tag => "0.6.2.2"}
  ...
  s.subspec 'IJKFFMoviePlayerController' do |spec|
     ...
     spec.source_files = "ijkplayer/ios/IJKMediaPlayer/IJKMediaPlayer/IJKFFMonitor.{h,m}","ijkplayer/ios/IJKMediaPlayer/IJKMediaPlayer/IJKMediaPlayer.{h,m}", "ijkplayer/ios/IJKMediaPlayer/IJKMediaPlayer/IJKFFOptions.{h,m}", "ijkplayer/ios/IJKMediaPlayer/IJKMediaPlayer/IJKFFMoviePlayerController.{h,m}", "ijkplayer/ios/IJKMediaPlayer/IJKMediaPlayer/IJKFFMoviePlayerDef.{h,m}"
